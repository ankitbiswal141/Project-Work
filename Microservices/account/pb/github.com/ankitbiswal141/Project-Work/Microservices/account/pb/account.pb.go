...
type PostAccountResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Account       *Account               `protobuf:"bytes,1,opt,name=account,proto3" json:"account,omitempty"` // Added field number
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetAccountsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Skip          uint64                 `protobuf:"varint,1,opt,name=skip,proto3" json:"skip,omitempty"` // Fixed typo from unint64 to uint64
	Take          uint64                 `protobuf:"varint,2,opt,name=take,proto3" json:"take,omitempty"` // Added field number for take
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_account_proto_rawDesc = "" +
	...
	"\vGetAccounts\x12\x16.pb.GetAccountsRequest\x1a\x17.pb.GetAccountsResponse\"\x00BAZ?github.com/ankitbiswal141/Project-Work/Microservices/account/pbb\x06proto3"
